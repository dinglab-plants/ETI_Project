...
print(summary(activity_treatment2))
print(Tuckey)
print(test_value)
...
plot1_4 = ggplot(el12[el12$Time == 24,], aes(y = value, x = Line))  +
  ...
  labs(y = "Conductivity\n(µS/mm)", x = "Line") + dlab_theme +
  scale_x_discrete(breaks = c("SETI ", "SETI eds1", "SETI helperless", "SETI adr1", "SETI nrg1"), labels=c(expression("SETI"), expression("SETI" ~ italic("eds1")), expression("SETI" ~ italic("helperless")), expression("SETI" ~ italic("adr1s")), expression("SETI" ~ italic("nrgs"))))
...
plot1_3 = ggplot(el12[el12$Time < 24,], aes(y = value, x = Line, fill = Treatment)) +
  ...
  scale_color_manual(values = c("black", "black")) +
  labs(y = "Conductivity\n[µS/mm]", x = "Line") + dlab_theme +
  scale_x_discrete(breaks = c("SETI ", "SETI eds1", "SETI helperless", "SETI adr1", "SETI nrg1"), labels=c(expression("SETI wt"), expression("SETI" ~ italic("eds1")), expression("SETI" ~ italic("helperless")), expression("SETI" ~ italic("adr1s")), expression("SETI" ~ italic("nrgs")))) +

...
fig_table_long_p$Gene_Name = factor(fig_table_long$Gene_Name, level = paste("CNGC", 1:20,sep = ""))
fig_table_long$adj.pval = fig_table_long_p$adj.pval
fig_table_long$significance = ""
fig_table_long$significance[fig_table_long$adj.pval <= 0.05] = "*"
...
fig_table_long = pivot_longer(fig_table_log2F, !Gene_Name, names_to = "Treatment", values_to = "adj.pval")
fig_table_long_p = pivot_longer(fig_table, !Gene_Name, names_to = "Treatment", values_to = "adj.pval")

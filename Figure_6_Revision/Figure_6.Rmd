...
gene_list = read.csv2("./Data/Immune_Pathways/3drnaseq/X2025.01.13.16.34.12.j145/result/Significant DE genes list and statistics_2.csv", sep = ",", dec = ".", header = TRUE)
...
all(unique(unlist(strsplit(c(paste(cluster_01$intersections, collapse = ","), paste(cluster_03$intersections, collapse = ","), paste(cluster_06$intersections, collapse = ","), paste(cluster_09$intersections, collapse = ",")), ","))) %in% unique(gene_list$target))

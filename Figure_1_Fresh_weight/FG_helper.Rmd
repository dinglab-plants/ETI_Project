...
helper_pooled_bar <- ggplot(data = fresh_weight3, aes(x = Line_mean, y = Fresh_weight_ratio_mean)) +
  ...
  dlab_theme +
  scale_x_discrete(limits = c("SETI_wt", "SETI_eds1", "SETI_adrs", "SETI_helperless", "SETI_nrgs", "Col-0"), labels=c(expression("SETI wt"), expression("SETI" ~ italic("eds1")), expression("SETI" ~ italic("adr1s")), expression("SETI" ~ italic("helperless")), expression("SETI" ~ italic("nrgs")), expression("Col-0"))) +
...
stats_table$Line_treatment = factor(row.names(LSD_result$groups), levels = c("M:SETI_wt", "E2:SETI_wt", "M:SETI_eds1",
                                                                           "E2:SETI_eds1", "M:SETI_adrs", "E2:SETI_adrs",
                                                                           "M:SETI_helperless", "E2:SETI_helperless",
